...
# Скрипт защиты от DDoS и базовых атак через firewalld (--direct), для систем **без Docker**
# Подходит для серверов с внешним интерфейсом EXT_IF и без внутреннего NAT/bridge
