...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'org.remmina.Remmina.desktop', 'doublecmd.desktop', 'google-chrome.desktop', 'code.desktop', 'org.gnome.Terminal.desktop']"
